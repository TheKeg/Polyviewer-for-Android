...
public class PolyviewerCheckBoxPreference extends CheckBoxPreference
{
   private Context parentContext;
   private View prefView;
   
   public PolyviewerCheckBoxPreference(Context context)
   {
      super(context);
   ...
   public PolyviewerCheckBoxPreference(Context context, AttributeSet attrs)
   {
      super(context, attrs);
